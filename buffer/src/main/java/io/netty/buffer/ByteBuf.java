...
/**
 * A random and sequential【顺序的】 accessible sequence of zero or more bytes (octets).
 *
 ...
 *
 * Just like an ordinary primitive【原始的】byte array, {@link ByteBuf} uses
 ...
 *
 * +------------------------------------------------------+
 * + pooled / unpooled   unsafe / 非unsafe  direct / heap +
 *
 *
 *  UnPooledHeapByteBuf
 *  UnpooledUnsafeHeapByteBuf
 *  UnpooledDritectByteBuf
 *  UnpooledUnsafeDriectBytebuf
 *  PooledHeapByteBuf
 *  PooledUnsafeHeapbyteBuf
 *  PooledDriectbytebuf
 *  PooledUnsafeDriectbyteBuf
 *  UnsafeByteBuf
 * +------------------------------------------------------+
 *
 */
